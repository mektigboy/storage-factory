...
contract StorageFactory {
    ...
    function createSimpleStorageContract() public {
        // simpleStorage = new SimpleStorage(); // Deploy new contract called "simpleStorage" of type <SimpleStorage>.
        SimpleStorage simpleStorage; // Variable named "simpleStorage" of type <SimpleStorage>.
        simpleStorage = new SimpleStorage(); // Assign the variable <simpleStorage> the value of a new contract <SimpleStorage>.
        arrayOfSimpleStorageContracts.push(simpleStorage); // Push a new contract to the array called "simpleStorageArray".
    }
